...
import static com.circle.common.core.domain.AjaxResult.error;
import static com.circle.common.core.domain.AjaxResult.success;
...
public class SysRegisterService
{
    ...
    public AjaxResult appRegister(SysUserDto dto){
        ...
        Boolean bool = this.checkUserName(dto.getUserName());
        if(!bool){
            msg = "注册失败, 账号已存在";
        }
    ...
    public Boolean checkUserName(String userName){
        ...
        return StringUtils.isNull(sysUser);
    }
